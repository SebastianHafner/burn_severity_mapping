...
def file2id(file: Path):
    patch_id = file.stem.split('_')[-1]
    return patch_id
...
def combine_tiff_tiles(folder: Path, base_name: str, delete_tiles: bool = False):
    ...
    ul_file = folder / f'{base_name}_{0:010d}-{0:010d}.tif'
    ...
    output_file = folder / f'mosaic_{base_name}.tif'
